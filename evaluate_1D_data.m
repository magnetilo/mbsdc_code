%%% Evaluating MBSDC framework for 1D eye movement data %%%
%
...
if exist('saccadeParamsTrueAll', 'var')
%     disp(' ')
%     disp(['Precision/Recall 0.6? (MBSDC): ' num2str(evaluationAllCollected.precisionEstim) ...
...
%         '/' num2str(evaluationAllCollected.recallFilt)])
    ...
    disp(' ')
    disp(['Precision/Recall for 0.6 deg. saccades (MBSDC): ' num2str(evaluationAll{1}.precisionEstim) ...
    ...
    disp(['Precision/Recall 1.2? (MBSDC): ' num2str(evaluationAll{2}.precisionEstim) ...
    ...
    disp(['Precision/Recall 2.5? (MBSDC): ' num2str(evaluationAll{3}.precisionEstim) ...
    ...
    disp(['Precision/Recall 5? (MBSDC): ' num2str(evaluationAll{4}.precisionEstim) ...
...
%     disp(['Precision/Recall ?? (MBSDC): ' num2str(evaluationAll{i}.precisionEstim) ...
...
if isfield(signalsAll{i}, 'posTrue')
    disp(' ')
    disp(['RMSE position (MBSDC): ' num2str(sqrt(evaluationCollected.MSEposEstim))])
    disp(['RMSE velocity (MBSDC): ' num2str(sqrt(evaluationCollected.MSEvelEstim))])
